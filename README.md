...
1. Зайдите в личный кабинет для настройки интеграции. Для входа необходимо использовать авторизационные данные системы EPOS (идентификатор клиента и секрет, не путать с логином и паролем от личного кабинета) ([см. скиншот](screens/login.png))
