...
1. Зайдите в личный кабинет для настройки интеграции. Для входа необходимо использовать авторизационные данные системы EPOS
    ...
    * [для тестового режима работы](https://test-cmsgate.esas.by/cmsgate-tilda-epos/config/login)
    ![login](screens/login.png){width=200px}
    ...
    ![tilda-epos-config](screens/config.png){width=400px}   
1. Зайдите в систему администрирования вашего магазина в Tilda
    ...
    1. Укажите обязательные параметры
        ...
        * Секрет для подписи заказа - значение скопированное в п.1.3 из поля **API Secret** 
        ![tilda-epos-config](screens/tilda_config.png){width=400px}   
